...
public class BrandEntryParamController implements Initializable, ScreenInterface {
    ...
    private GRider oApp;
    private final String pxeModuleName = "Brand Entry";
        ...
        switch (lsButton) {
            ...
            case "btnBrowse":
                if ((pnEditMode == EditMode.ADDNEW || pnEditMode == EditMode.UPDATE)) {
                    if (ShowMessageFX.YesNo(null, "Search Brand Information", "You have unsaved data. Are you sure you want to browse a new record?")) {
                    } else {
                        return;
                    }
                }
