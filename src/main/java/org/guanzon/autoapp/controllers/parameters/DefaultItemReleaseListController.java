 ...
 * @author John Dave
 */
public class DefaultItemReleaseListController implements Initializable, ScreenInterface, GRecordInterface {
    ...
    public boolean loadMasterFields() {
        txtField01.setText(oTrans.getModel().getModel().getItemCode());
        txtField02.setText(oTrans.getModel().getModel().getItemDesc());
    ...
    final ChangeListener<? super Boolean> txtField_Focus = (o, ov, nv) -> {
        ...
        if (!nv) {
            ...
            switch (lnIndex) {
                case 2:
                    oTrans.getModel().getModel().setItemDesc(lsValue);
                    break;
            }
        } else {
            txtField.selectAll();
    ...
    public void handleButtonAction(ActionEvent event) {
        ...
        switch (lsButton) {
            ...
            case "btnEdit":
                ...
                break;
            case "btnSave":
                if (ShowMessageFX.YesNo(null, "Default Item Released Information Saving....", "Are you sure, do you want to save?")) {
                    if (txtField02.getText().matches("[^a-zA-Z].*")) {
                        ShowMessageFX.Warning(null, "Default Item Released Information", "Please enter valid default item information.");
                        txtField02.setText("");
                        return;
                    }
                    if (txtField02.getText().trim().equals("")) {
                        ShowMessageFX.Warning(null, "Default Item Released Information", "Please enter value default item information.");
                        txtField02.setText("");
                        return;
                    }
                    loJSON = oTrans.saveRecord();
                    if ("success".equals((String) loJSON.get("result"))) {
                        ShowMessageFX.Information(null, "Default Item Released Information", (String) loJSON.get("message"));
                        ...
                        ShowMessageFX.Warning(null, "Default Item Released Information", (String) loJSON.get("message"));
                        return;
                    }
                }
                break;
            ...
            case "btnBrowse":
                if ((pnEditMode == EditMode.ADDNEW || pnEditMode == EditMode.UPDATE)) {
                    if (ShowMessageFX.YesNo(null, "Search Default Item Released Information", "You have unsaved data. Are you sure you want to browse a new record?")) {
                    } else {
                        return;
                    }
                }
                ...
                if ("success".equals((String) loJSON.get("result"))) {
                    ...
                    ShowMessageFX.Warning(null, "Search Default Item Released Information", (String) loJSON.get("message"));
                }
                break;
            case "btnClose":
            ...
            case "btnDeactivate":
                if (ShowMessageFX.OkayCancel(null, pxeModuleName, "Are you sure, do you want to change status?") == true) {
                    String fsValue = oTrans.getModel().getModel().getItemCode();
