 ...
 * @author John Dave
 */
public class BinController implements Initializable, ScreenInterface, GRecordInterface {
    ...
    public boolean loadMasterFields() {
        txtField01.setText(oTrans.getModel().getModel().getBinID());
        txtField02.setText(oTrans.getModel().getModel().getBinName());
    ...
    final ChangeListener<? super Boolean> txtField_Focus = (o, ov, nv) -> {
        ...
        if (!nv) {
            ...
            switch (lnIndex) {
                case 2:
                    loJSON = oTrans.getModel().getModel().setBinName(lsValue);
        ...
        switch (lsButton) {
            ...
            case "btnSave":
                if (ShowMessageFX.YesNo(null, "Bin Information Saving....", "Are you sure, do you want to save?")) {
                    if (txtField02.getText().matches("[^a-zA-Z].*")) {
                        ShowMessageFX.Warning(null, pxeModuleName, "Please enter valid bin information.");
                        txtField02.setText("");
                        return;
                    }
            ...
            case "btnDeactivate":
                if (ShowMessageFX.OkayCancel(null, pxeModuleName, "Are you sure, do you want to change status?") == true) {
                    String fsValue = oTrans.getModel().getModel().getBinID();
