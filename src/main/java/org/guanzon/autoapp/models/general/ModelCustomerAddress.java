...
//     private SimpleStringProperty addrindex13;
    ...
    public ModelCustomerAddress(String addrindex01,
            String addrindex02,
            String addrindex03,
            String addrindex04,
            String addrindex05,
...
//          this.addrindex13 = new SimpleStringProperty(addrindex13);
    ...
    public String getAddrindex01() {
        return addrindex01.get();
    }

    public void setAddrindex01(String addrindex01) {
        this.addrindex01.set(addrindex01);
    }

    public String getAddrindex02() {
        return addrindex02.get();
    }

    public void setAddrindex02(String addrindex02) {
        this.addrindex02.set(addrindex02);
    }

    public String getAddrindex03() {
        return addrindex03.get();
    }

    public void setAddrindex03(String addrindex03) {
        this.addrindex03.set(addrindex03);
    }

    public String getAddrindex04() {
        return addrindex04.get();
    }

    public void setAddrindex04(String addrindex04) {
        this.addrindex04.set(addrindex04);
    }

    public String getAddrindex05() {
        return addrindex05.get();
    }

    public void setAddrindex05(String addrindex05) {
        this.addrindex05.set(addrindex05);
    }

    public String getAddrindex06() {
        return addrindex06.get();
    }

    public void setAddrindex06(String addrindex06) {
        this.addrindex06.set(addrindex06);
    }

    public String getAddrindex07() {
        return addrindex07.get();
    }

    public void setAddrindex07(String addrindex07) {
        this.addrindex07.set(addrindex07);
    }

    public String getAddrindex08() {
        return addrindex08.get();
    }

    public void setAddrindex08(String addrindex08) {
        this.addrindex08.set(addrindex08);
    }

    public String getAddrindex09() {
        return addrindex09.get();
    }

    public void setAddrindex09(String addrindex09) {
        this.addrindex09.set(addrindex09);
    }

    public String getAddrindex10() {
        return addrindex10.get();
    }

    public void setAddrindex10(String addrindex10) {
        this.addrindex10.set(addrindex10);
    }
    /*
