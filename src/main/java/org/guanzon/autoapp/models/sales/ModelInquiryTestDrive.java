...
public class ModelInquiryTestDrive {
    ...
    private SimpleStringProperty tblindex02; //Make ID
    private SimpleStringProperty tblindex03; //Make Desc
    private SimpleStringProperty tblindex04; //Model ID
    private SimpleStringProperty tblindex05; //Model Desc

    public ModelInquiryTestDrive(String tblindex01, String tblindex02, String tblindex03, String tblindex04, String tblindex05) {
